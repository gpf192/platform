...
function userTotalChanceList818Controller($scope, $http, $state, $stateParams, $gridService, httpUtils, layerUtils,utils) {
	$scope.userVoteList= [];
	$scope.formData = {};
	$scope.init=function(){
		var data = {
	...
	$scope.getEmpList = function(pageSize) {
		var url = httpUtils.url.userTotalChanceList818;
		var clientName = "";
		var clientId = "";
		var mobile = "";
