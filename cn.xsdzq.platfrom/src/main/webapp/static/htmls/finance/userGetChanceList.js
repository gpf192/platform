...
function userGetChanceListController($scope, $http, $state, $stateParams, $gridService, httpUtils, layerUtils,utils) {
	$scope.userVoteList= [];
	$scope.formData = {};
	$scope.init=function(){
		var data = {
	...
	$scope.getEmpList = function(pageSize) {
		var url = httpUtils.url.userGetChanceList;
		var clientName = "";
		var clientId = "";
		var votes_source = "";
